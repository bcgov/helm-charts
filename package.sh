...
charts=("ckan-ui" "formio" "forum-api" "metadata-curator" "nifi" "ocp-pipeline" "ocp-route" "storage-api" "userguide-bridge-api" "vdi-project-api" "vdi-virtual-display" "konga")
