...
charts=("api-serv-ui" "api-serv-gwa" "batch-job" "ckan-ui" "formio" "forum-api" "metadata-curator" "nifi" "ocp-pipeline" "ocp-route" "ocp-terraform-pipeline" "storage-api" "userguide-bridge-api" "vdi-project-api" "vdi-virtual-display" "konga")
